...
const BookingForm = ({price,
    ...
    const handleDateChange=(value,dateString)=>{
        ...
        const caluclatedNights = moment(dateString[1],"YYYY-MM-DD",).diff(
          moment(dateString[0],"YYYY-MM-DD"),
          "days"
        );
        const caluclatedTotalPrice = price*caluclatedNights;
        handleFilterChange("nights",caluclatedNights);
        handleFilterChange("totalPrice",caluclatedTotalPrice);
    };
    let disabledDates =[];
